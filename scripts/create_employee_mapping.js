/**
 * Create employee-store mapping table and populate it
 * Run with: node scripts/create_employee_mapping.js
 */
...
async function createEmployeeMapping() {
  ...
  try {
    console.log('🔧 Creating employee_store_mapping table...');
    ...
    console.log('📝 Populating from sales data...');
    ...
    const result = await client.query(`
      SELECT 
        ...
        COUNT(DISTINCT outlet_name) as unique_outlets
    ...
    console.log(`\n📊 Sample mappings (top 10 by sales):\n`);
